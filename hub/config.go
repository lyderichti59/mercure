...
func SetFlags(fs *pflag.FlagSet, v *viper.Viper) {
	...
	fs.DurationP("write-timeout", "W", time.Duration(0), "maximum duration of a connection")
	fs.DurationP("dispatch-timeout", "T", 5*time.Second, "maximum duration of the dispatch of a single update")
